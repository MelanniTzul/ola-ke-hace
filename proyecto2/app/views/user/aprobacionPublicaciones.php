        ...
        <div class="container vh-100  justify-content-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    $publicaciones = $publicationController->getPublicacionesSinAprobar();
                    ?>

                    <div class="container mt-4">
                        <h2 class="text-center mb-4">Aprobación de Publicaciones Pendientes</h2>
                                ...
                                <tbody>
                                    <?php foreach ($publicaciones as $publicacion): ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($publicacion['id_categoria']); ?></td>
                                            <td><?php echo htmlspecialchars($publicacion['id_tipo_publico']); ?></td>
                                            <td><?php echo htmlspecialchars($publicacion['limite_personas']); ?></td>
                                            <td>
